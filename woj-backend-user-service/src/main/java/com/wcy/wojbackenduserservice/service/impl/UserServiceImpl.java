package com.wcy.wojbackenduserservice.service.impl;
...
import com.wcy.wojbackendmodel.model.dto.user.UserQueryRequest;
import com.wcy.wojbackendmodel.model.entity.User;
import com.wcy.wojbackendmodel.model.enums.UserRoleEnum;
import com.wcy.wojbackendmodel.model.vo.LoginUserVO;
import com.wcy.wojbackendmodel.model.vo.UserVO;
import com.wcy.wojbackenduserservice.mapper.UserMapper;
...
import static com.wcy.wojbackendcommon.constant.UserConstant.USER_LOGIN_STATE;
    ...
    public User getLoginUserPermitNull(HttpServletRequest request) {
        ...
        if (cookie.isEmpty()) {
            ...
            if (ObjectUtils.isNotEmpty(userJson)) {
                currentUser = JSONUtil.toBean(userJson.toString(), User.class);
            } else {
                return null;
            }
        }
